...
public class SimulationFragment extends Fragment {
    ...
    int[][] ADC_Values_Azimuth;
    int[][] ADC_Values_Elevation;
    ...
    private void sendAzimuthPair(Pair<Integer, Integer> data) {
        channelViewModel.setChannelDataAzimuth(data);
    }

    private void sendElevationPair(Pair<Integer, Integer> data) {
        channelViewModel.setChannelDataElevation(data);
    }
    ...
    private void initializeSyntheticData() {
        ...
        ADC_Values_Azimuth = new int[mockADC.length][2];
        ADC_Values_Elevation = new int[mockADC.length][2];

        for (int i=0; i<mockADC.length; i++) {
            String[] ch1ch2ch3ch4 = mockADC[i].split(",");
            int ADC1 = Integer.parseInt(ch1ch2ch3ch4[0]); // CH1:  ADC1 = 16.468 * dbm1 + 1155.3
            int ADC2 = Integer.parseInt(ch1ch2ch3ch4[1]); // CH2:  ADC2 = 16.461 * dbm1 + 1145.5
            int ADC3 = Integer.parseInt(ch1ch2ch3ch4[2]); // CH3:  ADC3 = 16.272 * dbm3 + 1131.4
            int ADC4 = Integer.parseInt(ch1ch2ch3ch4[3]); // CH4:  ADC4 = 16.014 * dbm4 + 1121
